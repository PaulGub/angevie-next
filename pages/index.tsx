        ...
        <Layout>
            <div className="lg:text-2xl text-xl">
                ...
                <div className="px-6 py-10 leading-loose">
                    ...
                    <h1 className="font-bold text-4xl uppercase text-pur ">Pour quelles raisons venir voir une
                        Energeticienne ?</h1>
                    ...
                    <div className={"grid grid-cols-5 gap-10"}>
                        ...
                        <div className={"items-center text-center flex flex-col bg-pur/30 p-4  rounded-lg"}>
                            ...
                            <div className={"bg-[url('/index/section1/1.jpg')] w-32 h-32 rounded-full bg-cover"}>
                            </div>
                        ...
                        <div className={"items-center text-center flex flex-col bg-pur/30 p-4  rounded-lg"}>
                            ...
                            <div className={"bg-[url('/index/section1/2.jpg')] w-32 h-32 rounded-full bg-cover"}>
                            </div>
                ...
                <div className="px-6 py-10 bg-pur text-stone-50 leading-loose">
                    ...
                    <h1 className="font-bold text-4xl uppercase">A qui s’adresse un bilan énergétique (Energeticienne)
                        ? </h1>

                    <p>- Enfant à partir de 7 ans jusqu’à 100 ans et plus. </p>
                    <p>- Les nouveaux nés jusqu’aux enfants de 7 ans sont dans l’énergie de la maman, le bilan se
                        réalise sur la mère. </p>
