        ...
        <footer>
            ...
            <div className="bg-pur text-stone-50 px-2 lg:py-0 py-4">
                ...
                <div className="grid">
                    ...
                    <div className="grid">
                        <div className="flex flex-col items-center justify-center">
                            <Image src={"/logo.svg"} width="200" height="200" alt="logo ange & vie" />
                        </div>
                    </div>
                    ...
                    <div className="grid">
                        <div className="flex flex-col items-center justify-center">
                            ...
                            <div className="flex pb-2">
                                ...
                                <p className=" transition duration-1000 ease-in-out  hover:scale-105 text-stone-5 text-stone-50 pl-2"><Link href="mailto:angeetvie@laposte.net">angeetvie@laposte.net</Link></p>
                            </div>
                            <div className="flex pb-2">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
                                    <path strokeLinecap="round" strokeLinejoin="round" d="M2.25 6.75c0 8.284 6.716 15 15 15h2.25a2.25 2.25 0 002.25-2.25v-1.372c0-.516-.351-.966-.852-1.091l-4.423-1.106c-.44-.11-.902.055-1.173.417l-.97 1.293c-.282.376-.769.542-1.21.38a12.035 12.035 0 01-7.143-7.143c-.162-.441.004-.928.38-1.21l1.293-.97c.363-.271.527-.734.417-1.173L6.963 3.102a1.125 1.125 0 00-1.091-.852H4.5A2.25 2.25 0 002.25 4.5v2.25z" />
                                </svg>
                                <p className="transition duration-1000 ease-in-out  hover:scale-105 text-stone-5 text-stone-50 pl-2"><Link href="tel:+33767055790">07 67 05 57 90</Link></p>
                            </div>
                            <div className="flex">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
