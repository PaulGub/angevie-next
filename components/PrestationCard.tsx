            ...
            <div>
                <div className={"w-full h-[400px] relative"}>
                    <Image className={"rounded-lg"} src={data.data.img} alt={"news"} layout={"fill"}
                        objectFit="cover" objectPosition={"center"} placeholder="blur" blurDataURL={data.data.img} />
                </div>

                <div className={"p-6"}>
                    <div className="flex justify-between border-b-2 border-stone-50">
                        <p className="border-l-4 border-stone-50 pl-2 text-stone-50 uppercase"> {data.data.title} </p>
                        <p>
                    ...
                    <p className={"text-stone-50 pt-3"}>{data.data.description}</p>
